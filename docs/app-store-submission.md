...
> 2026-08-18 再次被 Guideline 5.6 拒绝。build 13 已完成本地验证、IPA 核验、
> iPhone 17 Pro Max 真机安装与真实审核机连通实测，但尚未上传、选择或重新提交。
> 不要再选 build 6、11 或 12；下一步只能在用户最终确认后更新 ASC。
...
| 2.1.0 (13) | 本地已验证并在 iPhone 17 Pro Max 真机实测；移除伪聊天与虚假快捷键入口，修正商店/审核/支持文案；**尚未上传或提交** |
...
> 当前只允许把状态写成「build 13 已完成本地与真机验证，等待 ASC 操作确认」。
> 在 ASC live 状态确认前，
