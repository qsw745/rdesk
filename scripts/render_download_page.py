...
<section class="wake" id="wake"><div class="eyebrow">新功能 · 远程开机预览</div><h2>出门之后，也能请求电脑开机。</h2><p>让家中长期供电的安卓手机接收开机请求，再通过家庭局域网唤醒插网线的 Windows 电脑。无需在路由器开放公网端口。</p><div class="steps"><div><div class="number">01 / 家中安卓手机</div><strong>启用开机助手</strong><span>登录同一账号，连接家庭 Wi-Fi，保持充电并允许后台运行。</span></div><div><div class="number">02 / Windows 电脑</div><strong>检测网卡，生成配对码</strong><span>在电脑「开机」页检测有线网卡，用新版手机 RDesk 扫码确认，再在手机完成助手、BIOS 和测试。</span></div><div><div class="number">03 / 外出的设备</div><strong>点一下，请求开机</strong><span>在「设备」中找到电脑并点击开机；账号、助手在线状态和发送结果清楚显示。</span></div></div><p class="status">__STATUS__</p><p>“信号已发送”不代表电脑已启动；只有收到电脑应用心跳才显示上线。当前 App Store 版本尚不包含此项新功能。</p></section>
<section class="faq"><h2>下载前，你可能想了解</h2><details><summary>以后可以在应用里更新吗？</summary><p>从 2.2.1 开始，应用运行时会自动检查新版，也可进入「设置 → 关于 → 检查更新」。Windows、Android、Mac 可以下载并校验安装包，再按系统提示完成安装。旧版请先从官网手动安装一次。Mac 仍需拖入应用程序替换；iPhone 通过 App Store 更新，商店尚未发布的版本不会被当作更新。应用关闭时不会收到更新推送。</p></details><details><summary>哪些设备可以被远程操作？</summary><p>Android 与 macOS 可作为被控端。Windows 当前提供控制端与远程开机配置，尚不支持共享 Windows 桌面给别人操作。iPhone/iPad 可作控制端，也可分享屏幕，但不能接收远程触控。</p></details><details><summary>iPhone 可以像安卓一样下载文件安装吗？</summary><p>官网的苹果手机按钮会前往 App Store。普通 IPA 文件不能像 APK 一样在任意 iPhone 上直接安装。</p></details><details><summary>安装后需要开启哪些权限？</summary><p>Mac 被控需要屏幕录制与辅助功能权限；Android 屏幕共享和远程操作按应用提示授权。独立的安卓开机助手仅需网络、通知与后台运行，不要求录屏或无障碍。</p></details><details><summary>远程开机为什么需要实测？</summary><p>不同主板、网卡、Windows 电源状态及安卓后台策略存在差异。先测试睡眠与刚关机，再测试蜂窝网络、隔夜、24 小时和 48 小时。失败时先看助手是否在线，再看发送回执与电脑应用心跳。</p></details><details><summary>我的系统版本能安装吗？</summary><p>Mac 新版要求 macOS 12 或更高版本；Windows 支持 Windows 10/11 x64；Android 要求 7.0 或更高版本；iPhone/iPad 要求 iOS/iPadOS 13 或更高版本。请下载与你设备相符的安装包。</p></details></section></main>
...
notice = data.get('service_notice', '')
page = page.replace('__SERVICE_NOTICE__', f'<p class="status" role="status">{esc(notice)}</p>' if notice else '')
