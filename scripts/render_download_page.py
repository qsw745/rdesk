...
<section class="wake" id="wake"><div class="eyebrow">新功能 · 远程开机预览</div><h2>出门之后，也能请求电脑开机。</h2><p>让家中长期供电的安卓手机接收开机请求，再通过家庭局域网唤醒插网线的 Windows 电脑。无需在路由器开放公网端口。</p><div class="steps"><div><div class="number">01 / 家中安卓手机</div><strong>启用开机助手</strong><span>登录同一账号，连接家庭 Wi-Fi，保持充电并允许后台运行。</span></div><div><div class="number">02 / Windows 电脑</div><strong>按三步完成配置</strong><span>检测设备、核对 BIOS，再测试开机。自动识别网卡与唯一在线的家中助手。</span></div><div><div class="number">03 / 外出的设备</div><strong>点一下，请求开机</strong><span>在「设置 → 远程开机」选择电脑并点击开机，发送记录收在「更多」中。</span></div></div><p class="status">__STATUS__</p><p>“信号已发送”不代表电脑已启动；只有收到电脑应用心跳才显示上线。当前 App Store 版本尚不包含此项新功能。</p></section>
