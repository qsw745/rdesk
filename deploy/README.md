...
应在独立 CI / 构建机上生成 Linux x86_64 制品，验证其 GLIBC / 动态库要求与生产系统兼容，然后上传成品、保留旧二进制、原子替换并执行健康检查。部署构建分离前，不在生产机重试构建。详情见 [故障调查记录](../docs/validation/server-io-incident-2026-09-20.md)。
